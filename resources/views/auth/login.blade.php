  ...
  <body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="card " style="background-color: white; width:900px; height:500px; margin-top: 80px;">
                <div class="row d-flex justify-content-between">
                    <div class="col-6" style="">
                        <img src="{{ asset('storage/login.jpg') }}" alt=""" srcset="" style="height:498px; width:800px; ">
                    </div>
                    <div class="col-6 justify-content-center" style="background-color:white; padding-left:30px; padding-right:30px">
                        ...
                        <form method="POST" action="{{ route('login') }}" style="justify-content:center">
                            @csrf
                            ...
                            <div class="d-flex justify-content-start">
                                <p class="nav-link text-dark">Vous n'avez pas de compte? </p>
                                <a class="nav-link" href="{{ route('register') }}" style="margin-left: -28px">Inscrivez-vous</a>
                            </div>
